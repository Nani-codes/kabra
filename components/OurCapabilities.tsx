                ...
                <AnimateOnScroll animation="fadeInUp" delay={300} className="elementor-element elementor-widget elementor-widget-text-editor">
                  <div className="elementor-widget-container">
                    <div className="elementor-text-editor elementor-clearfix">
                      <h3 className="strategic-positioning-subheading">The Industry Standard for High-Stakes Reliability</h3>
                    </div>
                  </div>
                </AnimateOnScroll>
                  ...
                  <div className="elementor-widget-container">
                    <div className="elementor-text-editor elementor-clearfix">
                      ...
                      <ul className="strategic-positioning-list">
                        ...
                        <li><span className="industry-orange">Quality First:</span> For when consistency and repeatability matter more than the lowest bid.</li>
                      </ul>
                    </div>
                  </div>
                </AnimateOnScroll>
